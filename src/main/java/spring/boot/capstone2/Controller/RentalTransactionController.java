...
public class RentalTransactionController {
    ...
    @PostMapping("/add")
    public ResponseEntity addRentalTransaction(@Valid @RequestBody RentalTransaction rentalTransaction) {
    ...
    public ResponseEntity updateRentalTransaction(@Valid @RequestBody RentalTransaction rentalTransaction, @PathVariable Integer id) {
